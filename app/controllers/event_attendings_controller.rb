  ...
  def create
    ...
    respond_to do |format|
      if @event_attending.save
        format.html do
          redirect_to event_path(params[:attended_event_id]),
                      notice: 'You decided to attend this event'
        end
        format.json do
        ...
        format.html do
          redirect_to event_path(params[:attended_event_id]),
                      alert: 'Something is wrong. Check if your name already exists in the attendees list'
        end
        format.json do
          render json: @event_attending.errors, status: :unprocessable_entity
        end
      end
    end
  end
